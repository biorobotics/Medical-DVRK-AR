...
def tumor_estimation(tumor_points, which_tumor, tumorLoc1, tumorLoc2, tumorLoc3, tumorBinaryThresh):
	...
	for i in range(tumor_points.shape[0]):
		...
		dist1 = np.linalg.norm(curr_point,tumorLoc1)
		dist2 = np.linalg.norm(curr_point,tumorLoc2)
		dist3 = np.linalg.norm(curr_point,tumorLoc3)
...
def compute_accuracy(palpated_points, tumorLoc1, tumorLoc2, tumorLoc3, tumorBinaryThresh):
	...
	for i in [1,2,3]:
		tumor_estimation(tumor_points, i, tumorLoc1, tumorLoc2, tumorLoc3, tumorBinaryThresh)
