...
class sinWavePoints:
    ...
    def convert_array_to_pointcloud2(self):
        ...
        for i in range(self.point_nparray.shape[0]):
            ...
            est_points = self.estimation_numpy(init_points,0.05,1.0,self.start_time, rospy.get_rostime().to_sec())
...
if __name__ == "__main__":
    ...
    mySinWave.readArrayfromFile('/home/cora/dvrk/src/Medical-DVRK-AR/data/80degree_norm.npy')
