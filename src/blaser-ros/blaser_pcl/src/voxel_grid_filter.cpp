...
void parse_args(int argc, char** argv)
{
  ...
  desc.add_options()
    ...
    ("in_topic", po::value<std::string>(), "Input pointcloud topic (default blaser_pcl_topic)")
    ("out_topic", po::value<std::string>(), "Output pointcloud topic (default blaser_pcl_stitched)")
    ("srv_name", po::value<std::string>(), "Service name for interacting with stitcher")
    ("fixed_frame", po::value<std::string>(), "Fixed frame to transform to")
    ("leaf_size", po::value<float>(), "leaf size (meters) of the voxel grid filter");
